...
def show_mkt():
    ...
    **Негізгі формула:** $$p = n \\cdot m \\cdot v$$ 
    *(мұндағы $n$ - концентрация, $m$ - масса, $v$ - жылдамдық)*
    """)
    ...
    fig_atoms = go.Figure(
        ...
        layout=go.Layout(
            ...
            title="Ыдыс ішіндегі қозғалыс (визуалды)",
    ...
    st.metric("Есептелген қысым (p):", f"{p_current:.2e} Па")
    st.info("💡 Қысым — бұл молекулалардың ыдыс қабырғасына соғылуы. Масса немесе жылдамдық артса, соққы күші де артады.")