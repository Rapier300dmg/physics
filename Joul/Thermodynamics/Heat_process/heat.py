...
def show_heat_processes():
    ...
    with g1:
        ...
        fig_qc.update_layout(xaxis_title="c", yaxis_title="Q, Дж")
    ...
    with g2:
        ...
        fig_qt.update_layout(xaxis_title="ΔT", yaxis_title="Q, Дж")
        st.plotly_chart(fig_qt, use_container_width=True)

    st.success(f"Есептелген жылу мөлшері: {Q_total:.1f} Дж ({Q_total/1000:.2f} кДж)")